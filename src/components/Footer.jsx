    ...
    <footer className="relative z-10 bg-gray-900 text-white py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-bold mb-4">Wolke K8 Solutions</h3>
            <p className="text-gray-400 mb-4">Monitor & reduce Kubernetes spend</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white">Kubernetes Consulting</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Cloud Migration</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">DevOps Implementation</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Platform Engineering</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@kubernetesexperts.com">info@kubernetesexperts.com</a>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
